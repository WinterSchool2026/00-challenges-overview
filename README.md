...
| # | Challenge Title | Tutors | Group | Room |
|---|-----------------|--------|----------------------|----------------------|
| [CH-01](https://github.com/WinterSchool2026/ch01-seasfire) | [SeasFire: Deep Learning for Seasonal Wildfire danger Forecasting](#challenge-01) | [Nikolas Papadopoulos](#nikolas-papadopoulos) | 1. Rania Sahnoun<br>2. Ailish Graham<br>3. Konstantinos Vogiatzoglou<br>4. Suxun Li<br>5. Nuria Plaza-Martin| Venue 2 |
| [CH-02](https://github.com/WinterSchool2026/ch02-future-climate-downscaling) | [ML-based downscaling of future climate scenarios](#challenge-02) | [Mikhail Ivanov](#mikhail-ivanov) | 1. Alejandro Hermoso Verger<br>2. Sadegh Kaboli<br>3. Nikos Daniilidis<br>4. Midhuna Thayyil Mandodi<br>5. Sacha Peters<br>6. Eleni Georgali | Amphitheater |
| [CH-03](https://github.com/WinterSchool2026/ch03-ml-ocean-deoxygenation) | [Using machine learning to assess ocean deoxygenation trends in space and time](#challenge-03) | [Arianna Olivelli](#arianna-olivelli) | 1. Cristina Radin<br>2. Rasmus Henriksen<br>3. Jakov Lozuk<br>4. Sigrid Schødt Hansen<br>5. Andreas Wernecke | Amphitheather |
| [CH-04](https://github.com/WinterSchool2026/ch04-vegetation-buffer-meteo-extremes) | [Can vegetation buffer meteorological extremes events?](#challenge-04) | [Alexander Winkler](#alexander-winkler) | 1. Lily Puspasari<br>2. Jorunn Anna Mense<br>3. Sugandha Sugandha<br>4. Una Kelly | Venue 2 |
| [CH-05](https://github.com/WinterSchool2026/ch05-ai-esm-emulation-hybrid) | [Enhancing Earth System Modelling with Artificial Intelligence: Emulators vs Hybrid Models](#challenge-05) | [Said Ouala](#said-ouala) | 1. Pritthijit Nath<br>2. Ranit De<br>3. Theresia Yazbeck<br>4. Maximilian Pierzyna<br>5. Ada Canaydin<br>6. Alexandros Konis| Amphitheather |
| [CH-06](https://github.com/WinterSchool2026/ch06-mini-climate-emulation) | [Mini Climate Emulation](#challenge-06) | [Nathan Mankovich](#nathan-mankovich) | 1. Markella Bouchorikou<br>2. Yuchen Bai<br>3. Sally Sampson<br>4. Arnau Garcia Mesa<br>5. Stelian Curceac| Venue 2 |
| [CH-07](https://github.com/WinterSchool2026/ch07-spatiotemporal-uncertainty-ensembles) | [Seeing the spread: Visualizing spatiotemporal uncertainty in ensemble data](#challenge-07) | [Fangfei "Fei" Lan](#fangfei-fei-lan) | 1. Lennart Greiner<br>2. Victoria Bauer<br>3. Florian Kraulich<br>4. Tim Peirs<br>5. Frieder Loer<br>6. Danica Roco | Venue 1 |
| [CH-08](https://github.com/WinterSchool2026/ch08-deep-probabilistic-temperature) | [Deep Probabilistic Forecasting of Global Temperature Fields](#challenge-08) | [Aishwarya Venkataramanan](#aishwarya-venkataramanan) | 1. Svenja Ludwig<br>2. Juner Liu Liu<br>3. Ismail Bouizrou<br>4. Mohid Fayaz Mir<br>5. Amanda Batlle Morera| Venue 1 |
| [CH-09](https://github.com/WinterSchool2026/ch09-causal-inference-extremes) | [Causal Inference for Extreme Events](#challenge-09) | [Marta Sapena](#marta-sapena) | 1. Die Wang<br>2. Shalenys Bedoya-Valestt<br>3. Eric Samakinwa<br>4. Chrysoula Chitou<br>5. Samuele Capobianco<br>6. Wajiha Yasmeen| Amphitheather |
| [CH-10](https://github.com/WinterSchool2026/ch10-3d-hurricane-generation) | [Generating 3D video of hurricanes](#challenge-10) | [Emiliano Díaz Salas-Porras](#emiliano-díaz-salas-porras) | 1. Amalia Nikoleta Chantziara<br>2. Jannis Midasch<br>3. Marcos Martínez Roig<br>4. Saurabh Toraskar<br>5. Paul Jänsch | Venue 1 |
| [CH-11](https://github.com/WinterSchool2026/ch11-ml-attribution-extremes) | [Machine Learning for the Attribution of Extreme Events](#challenge-11) | [Homer Durand](#homer-durand) | 1. Xiaohuan Liu<br>2. Jorge Soto Martin<br>3. Svenja Seeber<br>4. Catherine Gregory<br>5. Thomas Melistas<br>6. Mijael Rodrigo Vargas Godoy | Venue 1 |
| [CH-12](https://github.com/WinterSchool2026/ch12-vlm-moe-multispectral) | [Lightweight Vision-Language Mixture-of-Experts for Interpretable Multispectral Satellite Representation Learning](#challenge-12) | [Mohanad Albughdadi](#mohanad-albughdadi) | 1. Thomas Hallopeau<br>2. Dimitra Karkani<br>3. Nelly Gaillard<br>4. Jordi Morales<br>5. Eleni Saka<br>6. Khizer Zakir| Venue 1 |
| [CH-13](https://github.com/WinterSchool2026/ch13-global-ecosystem-hybrid-parameterization) | [Learning global parameterizations of ecosystem processes using hybrid modelling](#challenge-13) | [Xu Shan](#xu-shan) | 1. Gabriele Pignalberi<br>2. Caroline Brand<br>3. Julian Siemens<br>4. Queen Suraajini Rajendran<br>5. Zhaoying Zhang| Venue 2 |
| [CH-14](https://github.com/WinterSchool2026/ch14-multimodal-drought-forecasting) | [Multi-modal learning for Impact-based forecasting of Droughts in Eastern Africa](#challenge-14) | [Vitus Benson](#vitus-benson) | 1. Leticia Pérez Sienes<br>2. Sai Ganesh Veeravalli<br>3. Niki Anastopoulou<br>4. Paula Fernandez Costa<br>5. Niklas Beck<br>6. Ayush Prasad| Amphitheather |
| [CH-15](https://github.com/WinterSchool2026/ch15-generative-insar) | [Generative models for Interferometric Synthetic Aperture Radar](#challenge-15) | [Nikolaos-Ioannis Bountos](#nikolaos-ioannis-bountos) | 1. Christos Athanasios Zervoudakis<br>2. Petros Stratis<br>3. George Panagiotou<br>4. Michelle Lin<br>5. Ioannis Maris| Venue 1 |
| [CH-16](https://github.com/WinterSchool2026/ch16-vlm-earth-observation) | [Vision-Language Models for EO: Connect imagery and text to enhance EO data interpretation](#challenge-16) | [Angelos Zavras](#angelos-zavras) | 1. Julia Bartsch<br>2. Alexandros Oikonomidis<br>3. Edward Gow-Smith<br>4. Liam Bailey<br>5. Hashempoorikderi Hamidreza<br>6. Christina Carty| Amphitheather | 
| [CH-17](https://github.com/WinterSchool2026/ch17-hybrid-land-atmosphere-fluxes) | [Hybrid modelling of land-atmosphere fluxes](#challenge-17) | [Reda ElGhawi](#reda-elghawi) &<br>[Sujan Koirala](#sujan-koirala) | 1. Sajjad Alghezi<br>2. Prashasti Shende<br>3. Helena Reid<br>4. Pritam Anurag<br>5. Miguel Hortelano Busto<br>6. Cian-Han Chen<br>7. Zhaochong An<br>8. Atefeh Torkaman Pary<br>9. Huayu Chen<br>10. Akshit Gupta | Venue 2|
...
**Overview:**
Climate risk analysis combines information about hazards, exposure, and vulnerability to estimate potential damages from natural disasters. The hazard–exposure–vulnerability framework provides the core structure of many risk models, though real-world risk assessments often incorporate additional factors such as protection measures, socioeconomic dynamics, and model uncertainty.

Rather than producing a single deterministic estimate of risk, modern risk models often consider multiple sources of uncertainty. These may include uncertain hazard intensity, uncertain asset values, or uncertainty in the vulnerability relationships that translate hazard intensity into damage. As a result, risk estimates can vary depending on model assumptions and input data.

The resulting datasets can be complex and multidimensional: storms occur across space and time, impacts vary across locations and assets, and risk metrics aggregate information across many possible events. Visualization plays a critical role in helping analysts interpret these patterns. However, communicating risk and uncertainty is challenging, and poorly designed visualizations can obscure important structures or misrepresent the variability of potential losses.

In this challenge, we will explore tropical cyclone risk using the CLIMADA risk modeling framework and a demo hazard dataset covering the Florida and Gulf of Mexico region. We will investigate how storm intensity, exposure distribution, and vulnerability interact to produce spatial patterns of damage and risk. The challenge is organized into two parts. In the first part, we will visually explore the risk modeling pipeline, examining hazard data, generating exposure datasets, computing impacts, and visualizing spatial risk patterns. In the second part, we will introduce uncertainty and sensitivity analysis, exploring how uncertainty in model inputs propagates to uncertainty in risk estimates and how visualization can help communicate and interpret these results.

The overall goal is to collaboratively explore climate risk modeling and develop visualization approaches that help reveal the structure, variability, and uncertainty of tropical cyclone impacts.
